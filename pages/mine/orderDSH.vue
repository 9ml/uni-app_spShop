<template>
	<view>
		...
		<view class="top-main">
			<view class="tm-bg">
				<image src="../../static/bg_dsh.png" mode=""></image>
			</view>
			<view class="tm-fonts">
				卖家已发货
			</view>
		...
		<view class="goods-mian" v-for="(g,g_idx) in userGoodsInfo" :key="g_idx">
			<view class="gm-gInfo">
				...
				<view class="gg-desc" @tap="goGoodsInfo(g.goodsId)">
					<view class="gd-name">
						{{g.goodsName}}
					</view>
					<view class="gd-type">
				...
				<view class="gg-btn" @tap="goRefund(g.orderGoodsId)">
					退款
				</view>
			</view>
		</view>
		...
		<view class="bom-main">
			...
			<view class="bm-right">
				<view class="br-btn-zf" @tap="acceptGoods()">
					确认收货
				</view>
			</view>
		</view>
